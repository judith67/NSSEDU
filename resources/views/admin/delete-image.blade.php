                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <img src="{{ asset('storage/'.$image->image ?? '') }}" alt="image" height=" 80" width="120">
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-3">
                                            <div class="position-relative">
                                                ...
                                                <a class="link-dark d-inline-block" href="/images/delete/{{ $image->id }}">
